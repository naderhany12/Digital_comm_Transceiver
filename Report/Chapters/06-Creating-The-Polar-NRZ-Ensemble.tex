...
\begin{listing} [!htpb]
    ...
    \label{listing:Polar-NRZ-Ensemble}
    \begin{minted}{matlab}
%% Polar NRZ
fprintf('\nPolar NRZ\n');
...
\begin{figure}[!htpb]
    ...
    \caption[Realization 1 and Realzation 2 from the Polar NRZ Ensemble]{Realization 1 and Realzation 2 from the Polar NRZ Ensemble.}
    \label{fig:POLAR-NRZ-ENSEMBLE}
\end{figure}

As we can see in \autoref{fig:POLAR-NRZ-ENSEMBLE}
\begin{itemize}
