...
We have already calculated the mean and autocorrelation across the ensemble in the previous questions, we also graphed across time and acroess realizations,
the two conditions in \autoref{eq:moment1} and \autoref{eq:moment2} are satisfied for all three formats, which means that the random process is ergodic.